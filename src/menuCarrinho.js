...
function desenharProdutoNoCarrinho(idProduto) {
    ...
    const articleClasses = ["flex", "bg-slate-900", "rounded-lg", "p-1", "relative"];
    ...
    const cartaoProdutoCarrinho = `      
        <button id="remover-item-${produto.id}" class="absolute top-0 right-2"><i class="fa-solid fa-circle-xmark hover:text-red-400"></i></button>
